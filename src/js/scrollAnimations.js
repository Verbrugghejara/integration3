...
function storkAnimation() {
  gsap
    .timeline({
      scrollTrigger: {
        trigger: ".location-section__birth", // Het element dat de animatie activeert
        // markers: { fontSize: "25px", fontWeight: "bold" }, // Visualiseer de start- en eindmarkers
        start: "top top", // Wanneer de bovenkant van het element het midden van de viewport raakt
        end: "bottom 170%", // Wanneer de onderkant van het element het midden van de viewport raakt
        scrub: true, // Synchroniseer animatie met scrollen
        onUpdate: (self) => {
    ...
    .to(".location-section__storkBaby", {
      left: "100%", // Verander de hoogte van de header__container bij scrollen
      ease: "none",
    });
}
function carveAnimation() {
  gsap.timeline({
    scrollTrigger: {
      trigger: ".location-section__newlife", // Het element dat de animatie activeert
      markers: { fontSize: "25px", fontWeight: "bold" }, // Visualiseer de start- en eindmarkers
      start: "top top", // Wanneer de bovenkant van het element het midden van de viewport raakt
      end: "bottom 170%", // Wanneer de onderkant van het element het midden van de viewport raakt
      scrub: true, // Synchroniseer animatie met scrollen
